...
const view = (state, actions) => (
    <div>
        ...
        <br/>
        <input type="file" accept="audio/*" capture="microphone" onchange={(event) => actions.onChangeFile(event)}></input>
        <br/>
...
function processBuffer (audioBuffer: AudioBuffer): AudioBuffer {
    ...
    for (let channel = 0; channel < audioBuffer.numberOfChannels; channel++) {
        ...
        for (let chunk = 0; chunk < Math.floor(channelData.length / 4096); chunk++) {
